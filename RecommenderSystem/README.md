...
This project aims to create a recommender system based on user demographics. The main algorithm used in finding the similarity of users is k-means clustering and k-neighborhood.
